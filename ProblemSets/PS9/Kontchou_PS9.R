...
modelParams <- makeParamSet(makeNumericParam("lambda",lower=0,upper=6),makeNumericParam("alpha",lower=1,upper=1))
...
modelParams <- makeParamSet(makeNumericParam("lambda",lower=0,upper=6),makeNumericParam("alpha",lower=0,upper=0))
